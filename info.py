...
USERNAME = environ.get('USERNAME', "https://telegram.me/DeoxysX")
...
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Aaki8490')
...
BIN_CHANNEL = int(environ.get('BIN_CHANNEL','-1002211393413'))
