...
USERNAME = environ.get('USERNAME', "https://telegram.me/Aaki551")
...
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002211393413'))
...
BIN_CHANNEL = int(environ.get('BIN_CHANNEL','-1002221865155'))
...
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002211393413'))
...
REF_PREMIUM = 30
PREMIUM_POINT = 1500
auth_channel = environ.get('AUTH_CHANNEL', '-1002147170605')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-1002149033246'))
request_channel = environ.get('REQUEST_CHANNEL', '-1002216982774')
REQUEST_CHANNEL = int(request_channel) if request_channel and id_pattern.search(request_channel) else None
UPI_PAY_LOGS = int(environ.get('UPI_PAY_LOGS', '-1008000054678'))
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002245047243'))
